    ...
    const fetchData = async () => {
      ...
      try {
        const token = localStorage.getItem('token');
                 const hRes = await fetch('https://apiheroe-qzs1phj28-uziels-projects-fa4bbf7c.vercel.app/api/heroes', {
           headers: {
             'Content-Type': 'application/json'
           }
         });
         const vRes = await fetch('https://apiheroe-qzs1phj28-uziels-projects-fa4bbf7c.vercel.app/api/villains', {
           headers: {
             'Content-Type': 'application/json'
           }
         });
    ...
    try {
      ...
      console.log('Datos a enviar:', {
        ...
        villainConfig
             ...
             const res = await fetch('https://apiheroe-qzs1phj28-uziels-projects-fa4bbf7c.vercel.app/api/battles/team', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
