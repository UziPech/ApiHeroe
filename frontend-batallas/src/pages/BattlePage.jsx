    ...
    try {
      ...
      if (!battleId) {
        ...
        return;
             ...
             const res = await fetch(`https://apiheroe-571rn3m1d-uziels-projects-fa4bbf7c.vercel.app/api/battles/${battleId}`, {
        headers: {
  ...
  const handleAttack = async (attackType) => {
    ...
    try {
      const token = localStorage.getItem('token');
             ...
             const res = await fetch(`https://apiheroe-571rn3m1d-uziels-projects-fa4bbf7c.vercel.app/api/battles/${battle.id}/attack`, {
        method: 'POST',
        headers: {
